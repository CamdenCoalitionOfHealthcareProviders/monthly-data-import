...
AllPayers$PRACTICE[AllPayers$VEND_FULL_NAME =="COOPER AMBULATORY PEDIATRICS"]<-"COOP_Ambulatory"
AllPayers$PRACTICE[AllPayers$VEND_FULL_NAME =="COOPER FAMILY MEDICINE"]<-"COOP_Family"
AllPayers$PRACTICE[AllPayers$VEND_FULL_NAME =="COOPER FAMILY MEDICINE PC"]<-"COOP_Family"
AllPayers$PRACTICE[AllPayers$VEND_FULL_NAME =="COOPER PEDIATRICS"]<-"COOP_Ambulatory"
AllPayers$PRACTICE[AllPayers$VEND_FULL_NAME =="COOPER PHYSICIANS OFFICES"]<-"COOP_PHYS"
AllPayers$PRACTICE[AllPayers$VEND_FULL_NAME =="COOPER PHYSICIAN OFFICES PA"]<-"COOP_PHYS"
...
AllPayers$PRACTICE[AllPayers$VEND_FULL_NAME =="ST LUKE'S CATHOLIC MED  SVCS"]<-"St. Luke"
AllPayers$PRACTICE[AllPayers$VEND_FULL_NAME =="ST LUKES CATHOLIC MEDICAL SERVICES INC"]<-"St. Luke"
AllPayers$PRACTICE[AllPayers$VEND_FULL_NAME =="VIRTUA EXPRESS IMMEDIATE CARE"]<-"Virtua Kyle Will"
AllPayers$PRACTICE[AllPayers$VEND_FULL_NAME =="VIRTUA FAMILY MEDICINE-COOPER RIVER"]<-"Virtua Kyle Will"
AllPayers$PRACTICE[AllPayers$VEND_FULL_NAME =="VIRTUA MEDICAL GROUP"]<-"Virtua Kyle Will"
AllPayers$PRACTICE[AllPayers$VEND_FULL_NAME =="VIRTUA MEDICAL GROUP PA"]<-"Virtua Kyle Will"
AllPayers$PRACTICE[AllPayers$VEND_FULL_NAME =="VIRTUA MEMORIAL HOSPITALIST GROUP"]<-"Virtua Kyle Will"
