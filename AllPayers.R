...
AllPayers$PRACTICE[AllPayers$VEND_FULL_NAME =="VIRTUA EXPRESS IMMEDIATE CARE"] <- "Virtua"
...
AllPayers$PRACTICE[AllPayers$VEND_FULL_NAME =="VIRTUA MEMORIAL HOSPITALIST GROUP"] <- "Virtua"
